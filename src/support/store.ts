...
const content = fs.readFileSync("documents/tabnews.txt", "utf-8");
// const content2 = fs.readFileSync("documents/verbose_transactions2.txt", "utf-8");
...
function categorizeContent(text: string): { category: string; topic: string } {
  ...
  } else if (text.includes('RAGAS') || text.includes('BLEU') || text.includes('ROUGE')) {
